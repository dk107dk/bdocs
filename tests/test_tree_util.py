...
class TreeUtilTests(unittest.TestCase):
    ...
    def test_clone(self):
        logging.info(f"TreeUtilTests.test_clone")
        tu = TreeUtil()
        one = { "a":"a", "b":"b", "m":{"n":"n", "o":"o"} }
        two = tu.clone(one)
        logging.info(f"TreeUtilTests.test_clone: two: {two}")
    ...
    def test_size(self):
        ...
        n = tu.size(tree)
        logging.info(f"TreeUtilTests.test_size: n: {n} vs len: {len(tree)}")
    ...
    def test_union(self):
        ...
        logging.info(f"TreeUtilTests.test_union: one: {one}")
        logging.info(f"TreeUtilTests.test_union: two: {two}")
        overlap1 = {}
        #
        result1 = tu.union(one,two, overlap=overlap1)
        logging.info(f"TreeUtilTests.test_union: result1: {result1}")
        logging.info(f"TreeUtilTests.test_union: overlap1: {overlap1}")
        ...
        logging.info(f"TreeUtilTests.test_union: result2: {result2}, overlap: {overlap2}, counts2: {counts2}")
        ...
        logging.info(f"TreeUtilTests.test_union: result3: {result3}, overlap: {overlap2}, counts2: {counts2}")
    ...
    def test_subtract(self):
        logging.info(f"TreeUtilTests.test_subtract")
        tu = TreeUtil()
        subthis  = { "a":"a", "b":"b", "m":{"n":"n", "o":"o"} }
        fromthat = { "a":"a", "b":"b", "c":"c", "d":"d" }
        fromthat['m'] = {"o":"o", "p":"p"}
        logging.info(f'TreeUtilTests.test_subtract: subtract this: {subthis}')
        logging.info(f'TreeUtilTests.test_subtract: from that: {fromthat}')
        result = tu.subtract(subthis, fromthat)
        logging.info(f'TreeUtilTests.test_subtract: result: {result}')
