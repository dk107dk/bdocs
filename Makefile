...
clean_pyc:
	@find $(MAKEFILE_DIR)/bdocs -name '*.pyc' -delete
	@find $(MAKEFILE_DIR)/bdocs -name '__pycache__' -delete

compile:
	@python -m compileall -f $(MAKEFILE_DIR)/bdocs

clean_dist:
	@rm -fr build dist bdocs.egg-info
